...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = React.createClass({
	  ...
	  render: function () {
	    return React.createElement('div', { className: 'header', __self: this
	    });
	  }
	});
	...
	var Side = React.createClass({
	  ...
	  render: function () {
	    return React.createElement('div', { className: 'side', __self: this
	    });
	  }
	});
	...
	var a = [];
	for (var i = 0; i < 10; i++) a.push(React.createElement(Sub1, { key: i, data: i, __self: this
	}));
	...
	var Sub2 = React.createClass({
	  ...
	  render: function () {
	    return React.createElement('div', { className: 'sub2', __self: this
	    });
	  }
	});
